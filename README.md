...
### Dashboard
![Dashboard Overview](/hr_ess_portal/screenshots/01-dashboard.png)
*Quick overview of pending requests, leave balance, and quick-action buttons*

### Leave Management
![Leave Request Form](/hr_ess_portal/screenshots/02-leave-request.png)
*Request leave with approval workflow*

### Attendance & Time Tracking
![Attendance Clock](/hr_ess_portal/screenshots/03-attendance-clock.png)
*Clock in/out directly from the portal*

![Attendance Correction](/hr_ess_portal/screenshots/04-attendance-correction.png)
*View attendance records and corrections*

### Timesheets
![Weekly Timesheet View](/hr_ess_portal/screenshots/05-timesheet-weekly.png)
*Modern weekly calendar view for logging hours by project*

![Timesheet Quick Entry](/hr_ess_portal/screenshots/06-timesheet-modal.png)
*Quick modal for adding/editing timesheet entries*

### Payslips
![Payslip Download](/hr_ess_portal/screenshots/07-payslips.png)
*View and download payslips as PDF*

### Expense Management
![Expense Submission](/hr_ess_portal/screenshots/08-expense-form.png)
*Submit expense claims with receipt attachments*

### Projects & Tasks
![Projects List](/hr_ess_portal/screenshots/09-projects.png)
*Browse active projects and assigned work*

![Tasks View](/hr_ess_portal/screenshots/10-tasks.png)
*View assigned tasks with priority and progress*

### Calender View
![Calender View](/hr_ess_portal/screenshots/11-calender-view.png)
